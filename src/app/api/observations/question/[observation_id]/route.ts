...
export async function GET(
  ...
  try {
    ...
    // Get questions for this observation type
    // In a real implementation, this would be based on the child's age group
    const questions = observationQuestions.filter(q => q.age_group === observation.child_age_group);
    ...
    console.error('Get observation questions error:', error);
    return NextResponse.json(
