...
export default function FormObservasiComponent() {
  ...
  const totalScore = questionsData.reduce((acc: number, q: Question) => {
  ...
  const handleNext = () => {
    ...
    const belumDiisi = pertanyaanKategori.some((q: Question) => answers[q.id]?.jawaban === undefined);
